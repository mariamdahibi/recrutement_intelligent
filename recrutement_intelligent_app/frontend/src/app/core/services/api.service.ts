...
export class ApiService {
  ...
  // Backend Spring Boot déployé sur la VM PROD
  private backendUrl = 'http://20.19.209.121:8080/api';

  // Json-server temporaire pour les données locales non encore disponibles dans le backend
  private mockUrl = 'http://localhost:3000';

  // Service IA FastAPI déployé sur la VM PROD
